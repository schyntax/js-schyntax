 ...
 * @private
 */
Validator.prototype._dayOfYear = function (expressionType, value)
{
	var ival = this._integerValue(expressionType, value, -366, 366);
	if (ival === 0)
		throw new Exceptions.SchyntaxParseError("Day of year cannot be zero.", this.input, value.index);
};
