...
Exceptions.InvalidScheduleError = function (message, input)
{
	this.input = input;	
	Error.call(this, message);
};

Util.inherits(Exceptions.InvalidScheduleError, Error);
...
Exceptions.ValidTimeNotFoundError = function (schedule)
{
	...
	Error.call(this, "A valid time was not found for the schedule.");
};
